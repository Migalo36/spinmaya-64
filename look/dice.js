...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-b2e372de');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-b2e372de');}
...
var brandEl=document.querySelector('.rl-brand-b2e372de');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
